...
```
Host (Directo): db.ztnfwtvvqefuahcgovru.supabase.co
Puerto (Directo): 5432
...
**- [ ] Vista `looker_leads_complete` visible (⚠️ **Si no aparece, ver sección 8.2**)
- [ ] Tiempos de respuesta calculados en Supabase
...
### Error: "No se encuentra la vista looker_leads_complete"

**Causa:** Es posible que durante la ejecución del script inicial, esta vista específica fallara debido a una dependencia temporal o caché de Supabase.

**Solución 1 (Rápida):**
1. Abre el **SQL Editor** en Supabase.
2. Copia y pega el contenido del archivo: `documentos/03_CONFIGURACION_LOOKER/FIX_VISTAS_LOOKER.sql`.
3. Ejecuta el script.
4. Regresa a Looker Studio y haz clic en el icono de **Refrescar** (↻) en la lista de tablas.

**Solución 2 (Verificación de Datos):**
Si la vista existe pero está vacía, asegúrate de que los cálculos se hayan ejecutado:
```sql
