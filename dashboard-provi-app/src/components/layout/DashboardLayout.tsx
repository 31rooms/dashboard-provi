        ...
        <div className="min-h-screen bg-[#f8fafc] flex overflow-hidden">
            ...
            >
                ...
                <nav className="flex-1 px-4 space-y-2 overflow-y-auto pt-4">
                    ...
                    <SidebarItem
                        ...
                        active={pathname === "/dashboard/remarketing"}
                        collapsed={collapsed}
                    />
                    <SidebarItem
                        icon={UserCircle}
                        ...
                        active={pathname === "/dashboard/brokers"}
                        collapsed={collapsed}
                    />

                    {/* Separador */}
                    {!collapsed && <div className="border-t border-slate-200 my-2"></div>}
            ...
            <aside className={cn(
                ...
                <nav className="flex-1 px-4 py-6 space-y-2">
                    ...
                    <SidebarItem icon={RefreshCw} label="Remarketing" href="/dashboard/remarketing" active={pathname === "/dashboard/remarketing"} />
                    <SidebarItem icon={UserCircle} label="Brokers" href="/dashboard/brokers" active={pathname === "/dashboard/brokers"} />

                    {/* Separador */}
                    <div className="border-t border-slate-200 my-2"></div>

                    <SidebarItem icon={Settings} label="Configuración" href="/dashboard/configuracion" active={pathname === "/dashboard/configuracion"} />
                </nav>
